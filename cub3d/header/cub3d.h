...
typedef struct	s_const 
{
	...
	int			xMapMax;
	int			yMapMax;
	double		ratio_of_texture_width_to_CUBE_NORD;
	double		ratio_of_texture_width_to_CUBE_South;
	double		ratio_of_texture_width_to_CUBE_EAST;
	double		ratio_of_texture_width_to_CUBE_WEST;
}				t_const;
